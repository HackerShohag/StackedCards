            ...
            Array.prototype.forEach.call(els, function (el, index) {
                ...
                el.addEventListener("click", function () {
                    ...
                    me.loopNodeList(els, function (el) {
                        ...
                        el.classList.remove("leftSlideAnimation")
                        el.classList.remove("rightSlideAnimation")
                        el.classList.remove("stackAnimation")
                    });
                    el.classList.add("active");
                    el.classList.add(me.config.layout);
                    if (index < prevIndex) {
                        el.classList.add("leftSlideAnimation");
                        document.documentElement.style.setProperty('--current-z-index', (parseInt(el.style.zIndex) - 1));
                    }
                    else if (index > prevIndex) {
                        el.classList.add("rightSlideAnimation");
                        // els[index + 1].style = (parseInt(el.style.zIndex) + 1);
